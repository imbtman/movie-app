    ...
    : data.map((file) => (
        <li key={file.id} className="relative ">
          <Link to={`/movie/${file.id}`}>
            <div className="relative mb-3 group scroll-smooth w-60  aspect-w-10 aspect-h-7 rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500 overflow-hidden">
